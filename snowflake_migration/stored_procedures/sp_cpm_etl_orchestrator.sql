...
BEGIN
    ...
    COPY INTO YTD_FILE_RAW FROM @STG_YTD_FILE ON_ERROR = CONTINUE;
    COPY INTO MER_FILE_RAW FROM @STG_MER_FILE ON_ERROR = CONTINUE;
    COPY INTO PAYMASTER_THREE_RAW FROM @STG_PAYMASTER_THREE ON_ERROR = CONTINUE;
    COPY INTO PAYMASTER_FILE_RAW FROM @STG_PAYMASTER_FILE ON_ERROR = CONTINUE;
    COPY INTO PAD_FILE_RAW FROM @STG_PAD_FILE ON_ERROR = CONTINUE;
