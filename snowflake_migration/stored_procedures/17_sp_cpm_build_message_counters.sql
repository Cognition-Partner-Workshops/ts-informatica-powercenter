...
BEGIN
    ...
    -- Write to counter table target
    INSERT INTO COUNTER_TBL (
        PP_END_YEAR, PP_NUM,
        INPUT_COUNT, CPM_COUNT, ERROR_COUNT,
        MULTI_PAY_COUNT, LOAD_DATE
    )
    VALUES (
        :P_PP_END_YEAR, :P_PP_NUM,
        :v_input_count, :v_cpm_count, :v_error_count,
        :v_multi_pay_count, CURRENT_DATE()
    );
