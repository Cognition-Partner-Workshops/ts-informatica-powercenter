...
BEGIN
    ...
    -- Truncate RAW and STG flat-file tables before reload
    TRUNCATE TABLE IF EXISTS RAW_YTD_FILE;
    TRUNCATE TABLE IF EXISTS RAW_MER_FILE;
    TRUNCATE TABLE IF EXISTS RAW_PAYMASTER_FILE;
    TRUNCATE TABLE IF EXISTS RAW_PAYMASTER_THREE;
    TRUNCATE TABLE IF EXISTS RAW_PAD_FILE;
    TRUNCATE TABLE IF EXISTS STG_YTD_FILE;
    TRUNCATE TABLE IF EXISTS STG_MER_FILE;
    TRUNCATE TABLE IF EXISTS STG_PAYMASTER_FILE;
    TRUNCATE TABLE IF EXISTS STG_PAYMASTER_THREE;
    TRUNCATE TABLE IF EXISTS STG_PAD_FILE;
