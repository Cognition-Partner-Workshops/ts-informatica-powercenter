...
BEGIN
    ...
    JOIN CPM_NEWPAY_STG_TYPE_3_TBL
        ON CPM_NEWPAY_STG_TYPE_1_2_TBL.PP_END_YEAR = CPM_NEWPAY_STG_TYPE_3_TBL.PP_END_YEAR
       AND CPM_NEWPAY_STG_TYPE_1_2_TBL.PP_NUM = CPM_NEWPAY_STG_TYPE_3_TBL.PP_NUM
       AND CPM_NEWPAY_STG_TYPE_1_2_TBL.DFAS_PSEUDO_SSN = CPM_NEWPAY_STG_TYPE_3_TBL.DFAS_PSEUDO_SSN
