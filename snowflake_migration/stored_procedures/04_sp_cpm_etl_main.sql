...
BEGIN
    ...
    -- Populates CPM_NEWPAY_TBL which Steps 11-13 depend on.
    ...
    -- =========================================================================
    -- Step 10: Load NEWPAY STG TYPE 3 FDR (m_CPM_Load_CPM_NEWPAY_STG_TYPE_3_FDR_TBL)
    -- Reads CPM_NEWPAY_TBL (populated by Step 9).
    -- Must run BEFORE Step 11 (FDR→NEWPAY) which reads TYPE_3_FDR.
    ...
    -- =========================================================================
    v_step := 'Step 10: NEWPAY STG TYPE 3 FDR';
    CALL SP_CPM_LOAD_NEWPAY_STG_TYPE_3_FDR(:P_PP_END_YEAR, :P_PP_NUM);
    v_msg := v_msg || v_step || ': done. ';

    -- =========================================================================
    -- Step 11: Load FDR to NEWPAY (m_CPM_Load_FDR_CPM_NEWPAY_TBL)
    -- Reads TYPE_3_FDR (populated by Step 10), writes to CPM_NEWPAY_TBL.
    -- Flow: CPM_NEWPAY_STG_TYPE_3_FDR -> SQ -> exp_Initial -> exp_Convert
    --       -> lkp_REG_REEMPLED -> exp_Final -> CPM_NEWPAY_TBL
    -- =========================================================================
    v_step := 'Step 11: FDR to NEWPAY';
    CALL SP_CPM_LOAD_FDR_TO_NEWPAY(:P_PP_END_YEAR, :P_PP_NUM);
    v_msg := v_msg || v_step || ': done. ';

    -- =========================================================================
    -- Step 12: Load NEWPAY STG DETAIL (m_CPM_Load_CPM_NEWPAY_STG_DETAIL_TBL)
    -- Reads CPM_NEWPAY_TBL (populated by Steps 9/11).
    -- Flow: CPM_NEWPAY_TBL -> SQ -> exp_Initial -> exp_Format_Fields
    --       -> agg_PYF_EYE_ID_PP_NUM -> exp_Final -> CPM_NEWPAY_STG_DETAIL_TBL
    -- =========================================================================
    v_step := 'Step 12: NEWPAY STG DETAIL';
    CALL SP_CPM_LOAD_NEWPAY_STG_DETAIL(:P_PP_END_YEAR, :P_PP_NUM);
    v_msg := v_msg || v_step || ': done. ';

    -- =========================================================================
    -- Step 13: Load NEWPAY STG TYPE 3 (m_CPM_Load_CPM_NEWPAY_STG_TYPE_3_TBL)
    -- Reads CPM_NEWPAY_TBL (populated by Steps 9/11).
    ...
    -- =========================================================================
    v_step := 'Step 13: NEWPAY STG TYPE 3';
